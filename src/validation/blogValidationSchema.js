...
export const blogValidationSchema = z.object({
  blog_id: z.string().optional(), // auto-generated

  title: z.string().min(3, "Title must be at least 3 characters"),
  author_name: z.string().min(2, "Author name must be at least 2 characters"),

  // 👇 allow either valid URL or empty string
  author_profile_url: z.string().url("Invalid URL").optional().or(z.literal("")),
  thumbnail_image_url: z.string().url("Invalid URL").optional().or(z.literal("")),
  share_url: z.string().url("Invalid URL").optional().or(z.literal("")),
